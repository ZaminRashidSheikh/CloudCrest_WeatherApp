...
for (let i = 0; i < 50; i++) {
  ...
  snowflake.style.top = Math.random() * -20 + 'vh'; // Start snowflakes slightly above the screen
...
window.onload = () => {
  ...
  // Ensure screen stays black initially
  // document.body.style.backgroundImage= 'media/cloudy5.jpg';

  setTimeout(() => {
      // Gradually change the background color
      // document.body.style.transition = 'background-color 5s';
      // document.body.style.backgroundImage = "cloudy5.jpg"; // Sky blue color

      // Animate the sun rising in the opposite direction
      sun.style.animation = 'sunrise 5s ease-in-out forwards';
